...
export default function LoginPage() {
    const { user, signInWithGoogle, signInWithEmail, error: authError } = useAuth();
            ...
            <div className="auth-container">
                <GlassPanel className="auth-panel">
                    <div className="auth-header">
                        ...
                        <h1 className="auth-title">Log into CEI</h1>
                        <p className="auth-subtitle">
                            Access your saved colleges, track match predictions, and manage your deadlines.
                        </p>
                    </div>
