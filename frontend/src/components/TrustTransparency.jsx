    ...
    <section className="nexus-home-section trust-section">
      <div className="home-section-inner">
        <header className="nexus-section-header">
          ...
          <ScrollReveal as="h2" containerClassName="fadeIn delay-1" baseRotation={0.8} blurStrength={6}>
            Scores you can look in the <span className="serif-accent">eye</span>.
          </ScrollReveal>
        ...
        <div className="nexus-why-cei-grid">
          <GlassPanel variant="strong" className="nexus-glass-card nexus-why-cei-card anti-gravity-card fadeIn delay-2">
            <h3>CEI score</h3>
            <p>
          ...
          <GlassPanel variant="default" className="nexus-glass-card nexus-why-cei-card anti-gravity-card fadeIn delay-3">
          ...
          <GlassPanel variant="default" className="nexus-glass-card nexus-why-cei-card anti-gravity-card fadeIn delay-4">
