...
const AMAZING_FACTS = [
    ...
    { id: 9, value: "TOP 1%", label: "BRAIN DRAIN", description: "Indian Institute of Technology alumni comprise some of the highest-paid tech CEOs in the world today.", icon: <Award />, accent: "blue" },
    { id: 10, value: "24/7", label: "KNOWLEDGE", description: "Indian Institute of Management Ahmedabad's library is so vast it has its own dedicated heritage ranking.", icon: <Library />, accent: "emerald" },
    ...
    { id: 15, value: "CEO FACTORY", label: "INDIAN INSTITUTE OF TECHNOLOGY DELHI", description: "This single campus has produced the world's highest density of startup unicorns.", icon: <Cpu />, accent: "purple" },
    ...
    { id: 17, value: "DEEP TECH", label: "INDIAN INSTITUTE OF TECHNOLOGY MADRAS", description: "Home to India's largest research park, housing over 200 deep-tech labs.", icon: <Microscope />, accent: "blue" },
    ...
    { id: 22, value: "MASSIVE", label: "INDIAN INSTITUTE OF TECHNOLOGY BOMBAY", description: "Hosts 'Techfest', which is the largest science festival in all of Asia.", icon: <Zap />, accent: "emerald" },
    { id: 23, value: "ROYAL ROI", label: "INDIAN INSTITUTE OF MANAGEMENT CALCUTTA", description: "One of the world's most triple-accredited elite management schools.", icon: <Briefcase />, accent: "purple" },
